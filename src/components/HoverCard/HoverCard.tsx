...
const lightTheme = {
  ...
  gradients: {
    card: "linear-gradient(to bottom right, #ff89cc, #9cb8ec, #62c2fe)",
    instagram: "linear-gradient(to bottom right, #fdf497, #ff53d4, #62c2fe)",
    twitter: "linear-gradient(to bottom right, #91e9ff, #00ACEE)",
    discord: "linear-gradient(to bottom right, #969fff, #b349ff)",
  },
};
...
const darkTheme = {
  ...
  gradients: {
    card: "linear-gradient(to bottom right, #6b2d4f, #3a466b, #1d6480)",
    instagram: "linear-gradient(to bottom right, #8f7b2b, #8f2162, #1d6480)",
    twitter: "linear-gradient(to bottom right, #2b6b80, #006a94)",
    discord: "linear-gradient(to bottom right, #4a4dd9, #6b29a3)",
  },
};
...
interface SocialLinkStyledProps {
  width: string;
  height: string;
  delay: string;
  gradient: keyof (typeof lightTheme)["gradients"];
}

const SocialLinkStyled = styled.div<SocialLinkStyledProps>`
  position: absolute;
  padding: 0.625rem;
  text-align: right;
...
const HoverCard: React.FC<HoverCardProps> = ({ isDarkTheme = false }) => {
  return (
